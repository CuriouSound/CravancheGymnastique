            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <img id ="logo"src="images/lacravanchoise.svg" alt="Blue logo">
                            </a>
                        </h1>
                    </div>
                </div>
                    ...
                    <div class="features-inner section-inner has-top-divider">
						<div class="features-header text-center">
							<div class="container-sm">
								<h2 class="section-title mt-0">Gymnastique</h2>
								<p class="section-paragraph mb-0">PLAISIR - PROGRES - MOUVEMENT - SANTE - AUTONOMIE - RESPECT</p>
							</div>
						</div>
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="images/equi.jpg" alt="Feature 01">
                                    </div>
                                    <h4 class="feature-title">GYM SANTE</h4>
                                    <p class="text-sm">L'équilibre</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="images/work.jpg" alt="Feature 02">
                                    </div>
                                    <h4 class="feature-title">GYME SANTE</h4>
                                    <p class="text-sm">L'habilité motrice</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="images/soupless.jpg" alt="Feature 03">
                                    </div>
                                    <h4 class="feature-title">GYM SANTE</h4>
                                    <p class="text-sm">La souplesse (stretching/mobilisation)</p>
                                </div>
                            </div>
                            <div class="feature is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img src="images/renfoo.jpg" alt="Feature 04">
                                    </div>
                                    <h4 class="feature-title">GYM SANTE</h4>
                                    <p class="text-sm">Le renforcement musculaire</p>
                                </div>
						...
						<div class="tabs-container">
							<ul class="tabs-links">
								<li class="is-revealing">
									<a href="#tab-1" class="tab-link is-active">
										<img src="images/tabs-icon-01.svg" alt="Tabs icon 01">
										<span class="h4 m-0">Amazing features</span>
									</a>
								</li>
								<li class="is-revealing">
									<a href="#tab-2" class="tab-link">
										<img src="images/tabs-icon-02.svg" alt="Tabs icon 02">
										<span class="h4 m-0">Endless possibilities</span>
									</a>
								</li>
								<li class="is-revealing">
									<a href="#tab-3" class="tab-link">
										<img src="images/tabs-icon-03.svg" alt="Tabs icon 03">
							...
							<div class="tabs-content">
								<div id="tab-1" class="tab-panel is-active">
									...
									<p class="mb-0">A arcu cursus vitae congue. Vel elit scelerisque mauris pellentesque pulvinar pellentesque habitant morbi tristique.</p>
								</div>
								<div id="tab-2" class="tab-panel">
									...
									<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. A arcu cursus vitae congue.</p>
								</div>
				...
				<div class="container">
					<div class="testimonials-inner section-inner">
						<div class="testimonials-header text-center text-light">
							<h2 class="section-title mt-0">L'équipe</h2>
						</div>
								...
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-body">
											<h1>Animatrice</h1>
											<p>Isabelle notre animatrice est certifiée d'un diplôme fédérale et d'un brevet d'état. Elle assure les cours tout au long de l'année sauf en cas de vacances scolaires</p>
										</div>
									</div>
            ...
            <div class="container">
                <div class="site-footer-inner">
                    <div class="brand footer-brand">
                        <a href="#">
                            <img src="images/logo.svg" alt="Blue logo">
                        </a>
                    </div>
                    ...
                    <div class="footer-copyright">&copy; 2018 Blue, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
